...
**killswitch**, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for killswitch**
...
- **version**: please note the version of **killswitch** are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of **killswitch** may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/killswitch
